...
credentials live in exactly one place (the environment) and migrations always
...
from app.database.registry import Base  # noqa: E402  (imports every model)
...
def run_migrations_online() -> None:
    ...
    with connectable.connect() as connection:
        context.configure(
            ...
            # skipped by autogenerate and the schema drifts from the models.
            compare_type=True,
            compare_server_default=True,
        )
        with context.begin_transaction():
