...
1. **Database** — <https://neon.tech>. Create a project, copy the connection
   string, and append `?sslmode=require`.
2. **API** — <https://render.com> → New Web Service, point it at this repo.
